...
from rllm.calc_r1.llm_agent.generation import GenerationConfig, LLMGenerationManager
...
class RayPPOTrainer(object):
    ...
    def _validate(self):
        ...
        for batch_dict in self.val_dataloader:
            ...
            #test_batch = test_batch.repeat(repeat_times=self.config.actor_rollout_ref.rollout.n_agent, interleave=True) # need to notice
