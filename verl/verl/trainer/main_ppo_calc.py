...
from verl.trainer.ppo.ray_trainer_calc import RayPPOTrainer
...
class RewardManager():
    ...
    def __call__(self, data: DataProto):
        ...
        def process_item(args):
            ...
            score = compute_score_fn(data_source="calm",llm_solution=sequences_str, ground_truth=ground_truth)
...
#     #                                     "http_proxy": "https://chenjunqi:ZKmNlaHaGeTII7qGOtfskpq6zyF9JFpvIExviR6nrfdzpMDy5FKV0R7Mxy0E@10.1.20.50:23128",
#     #                                     "https_proxy": "https://chenjunqi:ZKmNlaHaGeTII7qGOtfskpq6zyF9JFpvIExviR6nrfdzpMDy5FKV0R7Mxy0E@10.1.20.50:23128",
#     #                                     "no_proxy":'0.0.0.0'}}
#     #                                     ,_node_ip_address='0.0.0.0')
#     if not ray.is_initialized():
#         ray.init(runtime_env={'env_vars': {'TOKENIZERS_PARALLELISM': 'true', 
#                                        'NCCL_DEBUG': 'WARN',
#                                        "WANDB_MODE": "offline",s
#                                        "VLLM_ALLOW_LONG_MAX_MODEL_LEN": "1"}}
#                                         ,address='10.140.0.32:23466')
#     ray.get(main_task.remote(config))
...
def main_task(config):
    ...
    from verl.trainer.ppo.ray_trainer_calc import ResourcePoolManager, Role
