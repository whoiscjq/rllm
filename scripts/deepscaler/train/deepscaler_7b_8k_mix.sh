...
export experiment_name="7b_8k_mix_phrase1"
# Train over a single node, 8 A100-80GB GPUs.
/root/miniconda3/envs/off_rllm/bin/python -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=$BASE/rllm/data/MIX_PHRASE1/deepscaler_train.parquet \
    data.val_files=$BASE/rllm/data/MIX_PHRASE1/mix_phrase1_test.parquet \
