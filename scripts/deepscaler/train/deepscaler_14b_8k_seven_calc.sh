...
MODEL_PATH="/oss/chenjunqi/rllm/checkpoints/deepcausal/14b_8k_seven_python/actor/global_step_30"
...
export experiment_name="14b_8k_seven_python_continue2"
# Train over a single node, 8 A100-80GB GPUs.
/root/miniconda3/envs/off_rllm/bin/python -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=$BASE/rllm/data/seven_python/deepscaler_train.parquet \
    data.val_files=$BASE/rllm/data/seven_python/mix_phrase1_test.parquet \
