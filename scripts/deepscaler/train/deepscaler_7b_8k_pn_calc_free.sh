...
MODEL_PATH="/oss/chenjunqi/rllm/checkpoints/deepcausal/7b_8k_pn_calc/actor/global_step_30"
...
export experiment_name="14b_8k_pn_calc_zshot"
# Train over a single node, 8 A100-80GB GPUs.
/root/miniconda3/envs/off_rllm/bin/python -m verl.trainer.main_ppo_calc \
    algorithm.adv_estimator=grpo \
    data.train_files=$BASE/rllm/data/PN_calc_zshot/deepscaler_train.parquet \
    data.val_files=$BASE/rllm/data/PN_calc_zshot/pn_test.parquet \
