...
export experiment_name="14b_4k_five_calc_zshot"
# Train over a single node, 8 A100-80GB GPUs.
/root/miniconda3/envs/off_rllm/bin/python -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=$BASE/rllm/data/five_python/deepscaler_train.parquet \
    data.val_files=$BASE/rllm/data/five_python/mix_phrase1_test.parquet \
